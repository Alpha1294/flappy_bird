...
class Base:
    ...
    def move(self):
        # move 2 images that are the same and when the first is off the screen put it behind the 2nd imageand so on
        self.x1 -= self.VEL
        self.x2 -= self.VEL
...
def run(config_path):
    ...
    # call main function 50 times and generate all the genomas
